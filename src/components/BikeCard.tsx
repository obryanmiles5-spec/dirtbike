  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        ...
        <div className="grid grid-cols-3 gap-1.5 py-3 border-y border-zinc-800/90 bg-zinc-950/60 rounded-lg px-2 font-mono">
          <div className="flex flex-col items-center justify-center text-center p-1">
            <div className="flex items-center gap-1 text-lime-400 font-extrabold text-xs mb-0.5">
              <Zap className="w-3 h-3 fill-lime-400/20" />
              <span>{bike.specs.peakPowerKW} kW</span>
            </div>
            <span className="text-[9px] text-zinc-400 font-bold uppercase tracking-wider font-sans">PEAK POWER</span>
          </div>

          <div className="flex flex-col items-center justify-center text-center p-1 border-x border-zinc-800">
            <div className="flex items-center gap-1 text-lime-400 font-extrabold text-xs mb-0.5">
              <Battery className="w-3 h-3" />
              <span>{bike.specs.batteryVoltage}V</span>
            </div>
            <span className="text-[9px] text-zinc-400 font-bold uppercase tracking-wider font-sans">VOLTAGE</span>
          </div>

          <div className="flex flex-col items-center justify-center text-center p-1">
            <div className="flex items-center gap-1 text-lime-400 font-extrabold text-xs mb-0.5">
              <MapPin className="w-3 h-3" />
              <span>{bike.specs.rangeMilesMax} mi</span>
            </div>
            <span className="text-[9px] text-zinc-400 font-bold uppercase tracking-wider font-sans">RANGE</span>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between gap-2 pt-1">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2.5 rounded-lg bg-lime-400 hover:bg-lime-300 text-zinc-950 font-black text-xs uppercase tracking-wider shadow-md shadow-lime-400/20 transition-all transform active:scale-95 cursor-pointer"
          >
